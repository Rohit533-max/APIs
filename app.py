...
lis = ["USD","EUR","GBP","JPY","INR","CAD","AUD","CHF","CNY","HKD","SGD","NZD","SEK","NOK","DKK","KRW","THB","MYR","IDR","PHP","VND","AED","SAR","QAR","ZAR","BRL","MXN","TRY","RUB","EGP"]
lis2 = ["INR","EUR","GBP","JPY","USD","CAD","AUD","CHF","CNY","HKD","SGD","NZD","SEK","NOK","DKK","KRW","THB","MYR","IDR","PHP","VND","AED","SAR","QAR","ZAR","BRL","MXN","TRY","RUB","EGP"]
col1,col2,col3 = st.columns([1,2,4])

with col1:
    amount = st.number_input("Amount",width=50,min_value=1)
with col2:
    from_curr = st.selectbox("Main curr_code",lis,width=100)
with col3:
    to_curr = st.selectbox("Converting curr_code",lis2,width=130)
